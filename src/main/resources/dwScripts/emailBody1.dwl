...
<div class="container-fluid">
    ...
    <p style="text-align: center;">
        ...
        On this special day, I would like to draw your attention to the birthdays of some of our esteemed colleagues.
        Let's join together in wishing them a very happy birthday and making their day even more special.
        <br><br>The birthdays we are celebrating today are:
    </p>`
...
<table style="border-collapse: collapse; width: 100%;">
        <tr>
            ...
            <th style="border: 1px solid #ddd; padding: 8px; text-align: left; background-color: #088bde; color: white; padding-top: 12px; padding-bottom: 12px;">Age</th>
...
var tableRows = vars.Birthdays map ((person, index) -> 
    "<tr>\n" ++
    "    <td style='border: 1px solid #ddd; padding: 8px;'>" ++ person.id ++ "</td>\n" ++
    "    <td style='border: 1px solid #ddd; padding: 8px;'>" ++ person.name ++ "</td>\n" ++
    "    <td style='border: 1px solid #ddd; padding: 8px;'>" ++ (now().year - person.birthday.year as String) ++ "</td>\n" ++
